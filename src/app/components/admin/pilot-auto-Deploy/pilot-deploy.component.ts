...
@Component({
  selector: 'pilot-auto-deploy',
  templateUrl: './pilot-deploy.component.html',
  styleUrls: [],
  providers:[EditService]
})
export class PilotAutoDeploy implements OnInit {
	public view:any[] = [];
    ...
    public ngOnInit(): void {
        ...
        this.pilotGroupingList = [
            {"groupCode": "Eastern", "groupDescription": "Eastern"},
            {"groupCode": "WestCost", "groupDescription": "West Cost"},
            {"groupCode": "Mobil", "groupDescription": "Mobil"},
            {"groupCode": "KappleBrani", "groupDescription": "Kapple / Brani"},
            {"groupCode": "Bukom", "groupDescription": "Bukom"},
            {"groupCode": "Project", "groupDescription": "Project"},
            {"groupCode": "MAS", "groupDescription": "MAS"},
            {"groupCode": "SAFYC", "groupDescription": "SAFYC"}
        ]
        // this.editService.read();
    }
    public loadData (){
        this.checkData = [];
        this.editService.getPilotGroupingDetails()
        .subscribe(data =>{
            data.forEach(key=> {
            ...
            console.log("Grid data",this.girdData)
        })
    }
    ...
    public getShiftTypeDetails (){
        this.editService.getPilotGroupShiftTypeDetails()
        .subscribe(res => {
