...
@Component({
  ...
  template: `
      <kendo-grid [data]="delay"
        ...
        <kendo-grid-column field="previousCategory" title="Previous Priority Code">
        </kendo-grid-column>
        <kendo-grid-column field="updatedCategory" title="Updated Priority Code">
        </kendo-grid-column>
