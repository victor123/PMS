...
import { TsdsModel, TugDetailsFilterModel } from '../../../shared/modals/form.model';
import { Observable } from 'rxjs/Observable';
import { SortDescriptor, orderBy } from '@progress/kendo-data-query';
import * as moment from 'moment';
@Component({
  selector: 'tug-grid',
  templateUrl: './tug-details.component.html',
  styleUrls: [],
  providers: [PilotDemandDataService, CategoriesService]
})
export class TugDetailsComponent {
  ...
  public jobDemandFilterModel: TugDetailsFilterModel;
...
@ViewChild('dropdown') el:ElementRef;
  ...
  constructor(public services: PilotDemandDataService, public service: CategoriesService, public fb: FormBuilder, public intl: IntlService) {
    ...
    this.jobDemandFilterModel = new TugDetailsFilterModel();
  ...
  public loadGridData(jobDemandFilterModel: TugDetailsFilterModel) {
    ...
    this.services.tugjobtableData(jobDemandFilterModel).subscribe((res) => {
      this.gridDataa = res;
  ...
  public onFilter(value: any) {
    ...
    this.gridData = process(this.gridDataa, this.state)
    this.services.tugfilterService(value, (res) => {
      this.state.skip=0;
      this.state.take=5;
      this.state.sort=[];
      this.pageSize=5;
  ...
  onReset() {
    ...
    this.services.tugfilterService(this.filterForm.value, (res) => {
      this.state.skip=0;
      this.state.take=5;
      this.state.sort=[];
      this.pageSize=5;
